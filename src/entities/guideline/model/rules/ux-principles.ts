...
export const UX_RULES: Rule[] = [
  ...
  {
    id: 'error-prevention.confirm',
    topicId: 'error-prevention',
    sectionId: 'ux-principles',
  },
  {
    id: 'error-prevention.constraints',
    topicId: 'error-prevention',
    sectionId: 'ux-principles',
  },
  {
    id: 'loading-states.skeleton',
    topicId: 'loading-states',
    sectionId: 'ux-principles',
  },
  {
    id: 'loading-states.layout-shift',
    topicId: 'loading-states',
    sectionId: 'ux-principles',
  },
  {
    id: 'empty-states.explain-action',
    topicId: 'empty-states',
    sectionId: 'ux-principles',
  },
