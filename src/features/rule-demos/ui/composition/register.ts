...
import { GridBad, GridGood, LongTextBad, LongTextGood } from './AlignmentDemo'
...
registerDemos({
  'layout.max-width': { Good: MaxWidthGood, Bad: MaxWidthBad, layout: 'stacked' },
  ...
  'alignment.long-text': { Good: LongTextGood, Bad: LongTextBad, layout: 'stacked' },
